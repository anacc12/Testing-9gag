...
public class TestBase {
    ...
    public  TestBase(){
        try{
            prop = new Properties();
            FileInputStream ip = new FileInputStream("C:\\Users\\Korisnik\\IdeaProjects\\Testing-9gag\\src\\main\\java\\com\\test9gag\\qa\\config\\config.properties");
            prop.load(ip);
